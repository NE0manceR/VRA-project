  ...
  return (
    <div ref={caseRef} style={{ position: 'relative' }}>
          ...
          <div className="Template-text">
            ...
            {currentItem?.author ? (
              <Fragment>
                ...
                <p className="subtitle2 author-name">{currentItem?.author}</p>
              ...
              {currentItem?.aim?.list.map((aimList) => {
                return (
                  ...
                  >
                    ...
                    <span className="Goals__text">{aimList.item}</span>
                  </div>
                );
              })}
            </div>
            <div className="Tasks">
              ...
              <ol>
                {currentItem?.tasks.map((taskItem) => {
                  return <li key={'taskItem' + taskItem.id}>{taskItem.item}</li>;
                })}
              </ol>
            </div>
          </div>
      ...
      <div className="Project-photo">
        ...
        <div className={`Project-photo__wrap Project-photo-grid-${currentItem?.photos.length}`}>
          {currentItem?.photos.map(({ id, url }) => {
            return (
              <div
                onClick={() => {
                  funcSlider();
                ...
                key={id}
                className={`Project-photo__bcg area-${++photoArea}`}
